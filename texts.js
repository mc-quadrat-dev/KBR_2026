...
const GAME_TEXTS = {
  ...
  info: {
    ...
    howTo: [
      ...
      "Anliegen (farbige Punkte) fahren automatisch mit – nimm alle mit, sonst sinkt die Netzstabilität.",
  ...
  tutorial: {
    ...
    firstStation: "Hier startet dein Netz. Diese Station gehört zum {FARBE} Kontinent.",

    /* An der zweiten Station */
    secondStation: "Verbinde diese Station: Station antippen und zur anderen ziehen.",
    ...
    firstTransport: "Diese Punkte sind Anliegen. Das Netz bleibt nur stabil, wenn ALLE mitgenommen werden.",
    ...
    wildPoint: "Achtung: Auch freie Anliegen müssen mitgenommen werden. Platziere eine Station oder Linie in der Nähe.",
